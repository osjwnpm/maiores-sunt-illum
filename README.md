# `@osjwnpm/maiores-sunt-illum` <sup>[![Version Badge][npm-version-svg]][package-url]</sup>
...
```sh
npm install eslint @osjwnpm/maiores-sunt-illum --save-dev
```
...
If you are using the [new JSX transform from React 17](https://reactjs.org/blog/2020/09/22/introducing-the-new-jsx-transform.html#removing-unused-react-imports), extend [`react/jsx-runtime`](https://github.com/osjwnpm/maiores-sunt-illum/blob/c8917b0885094b5e4cc2a6f613f7fb6f16fe932e/index.js#L163-L176) in your eslint config (add `"plugin:react/jsx-runtime"` to `"extends"`) to disable the relevant rules.
...
**Note**: These configurations will import `@osjwnpm/maiores-sunt-illum` and enable JSX in [parser options](https://eslint.org/docs/user-guide/configuring/language-options#specifying-parser-options).
...
The default export of `@osjwnpm/maiores-sunt-illum` is a plugin object.

```js
const react = require('@osjwnpm/maiores-sunt-illum');
...
- `@osjwnpm/maiores-sunt-illum/configs/all`
- `@osjwnpm/maiores-sunt-illum/configs/recommended`
- `@osjwnpm/maiores-sunt-illum/configs/jsx-runtime`

If your eslint.config.js is ESM, include the `.js` extension (e.g. `@osjwnpm/maiores-sunt-illum/recommended.js`). Note that the next semver-major will require omitting the extension for these imports.

**Note**: These configurations will import `@osjwnpm/maiores-sunt-illum` and enable JSX in [`languageOptions.parserOptions`](https://eslint.org/docs/latest/user-guide/configuring/configuration-files-new#configuration-objects).
...
```js
const reactRecommended = require('@osjwnpm/maiores-sunt-illum/configs/recommended');
...
💼 [Configurations](https://github.com/osjwnpm/maiores-sunt-illum/#shareable-configs) enabled in.\
🚫 [Configurations](https://github.com/osjwnpm/maiores-sunt-illum/#shareable-configs) disabled in.\
🏃 Set in the `jsx-runtime` [configuration](https://github.com/osjwnpm/maiores-sunt-illum/#shareable-configs).\
☑️ Set in the `recommended` [configuration](https://github.com/osjwnpm/maiores-sunt-illum/#shareable-configs).\
...
- Rules of Hooks: [@osjwnpm/maiores-sunt-illum-hooks](https://github.com/facebook/react/tree/master/packages/@osjwnpm/maiores-sunt-illum-hooks)
- JSX accessibility: [eslint-plugin-jsx-a11y](https://github.com/jsx-eslint/eslint-plugin-jsx-a11y)
- React Native: [@osjwnpm/maiores-sunt-illum-native](https://github.com/Intellicode/@osjwnpm/maiores-sunt-illum-native)

## License

`@osjwnpm/maiores-sunt-illum` is licensed under the [MIT License](https://opensource.org/licenses/mit-license.php).

[npm-url]: https://npmjs.org/package/@osjwnpm/maiores-sunt-illum
[npm-image]: https://img.shields.io/npm/v/@osjwnpm/maiores-sunt-illum.svg

[status-url]: https://github.com/osjwnpm/maiores-sunt-illum/pulse
[status-image]: https://img.shields.io/github/last-commit/jsx-eslint/@osjwnpm/maiores-sunt-illum.svg

[tidelift-url]: https://tidelift.com/subscription/pkg/npm-@osjwnpm/maiores-sunt-illum?utm_source=npm-@osjwnpm/maiores-sunt-illum&utm_medium=referral&utm_campaign=readme
[tidelift-image]: https://tidelift.com/badges/package/npm/@osjwnpm/maiores-sunt-illum?style=flat

[package-url]: https://npmjs.org/package/@osjwnpm/maiores-sunt-illum
[npm-version-svg]: https://versionbadg.es/jsx-eslint/@osjwnpm/maiores-sunt-illum.svg

[actions-image]: https://img.shields.io/endpoint?url=https://github-actions-badge-u3jn4tfpocch.runkit.sh/jsx-eslint/@osjwnpm/maiores-sunt-illum
[actions-url]: https://github.com/osjwnpm/maiores-sunt-illum/actions
